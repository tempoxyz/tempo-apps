	...
	return (
        ...
        <div 
          ...
          style={{
            ...
            transform: introPhase !== "initial" ? "translateY(0)" : "translateY(12px)",
          }}
        >
					<ExploreInput
        ...
        >
          ...
          >
            <button
              ...
              style={isExplorePulse ? { borderColor: "rgba(59, 130, 246, 0.5)" } : undefined}
				>
...
function SpotlightPill(props: {
  ...
  const { to, params, search, icon, badge, pulse, visible = true, delay = 0, children } = props;
	return (
		<Link
			to={to}
			{...(params ? { params } : {})}
