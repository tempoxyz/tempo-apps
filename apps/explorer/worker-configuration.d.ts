/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 368fd7920974992e6945bd80d886b051)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		PORT: string;
		ENVIRONMENT: string;
		VITE_ENABLE_ERUDA: string;
		VITE_ENABLE_COLOR_SCHEME_TOGGLE: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BASIC_AUTH_USERNAME" | "BASIC_AUTH_PASSWORD" | "PORT" | "ENVIRONMENT" | "VITE_ENABLE_ERUDA" | "VITE_ENABLE_COLOR_SCHEME_TOGGLE" | "INDEXSUPPLY_API_KEY">> {}
}
