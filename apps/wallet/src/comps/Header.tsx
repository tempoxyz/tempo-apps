...
export function Header() {
	return (
		<header className="relative z-1">
			<div className="px-[24px] pt-[36px] flex items-center justify-between min-h-8 select-none relative z-1">
...
export namespace Header {
	export function NetworkBadge(props: { className?: string }) {
	...
	export function TempoWordmark(props: { className?: string }) {
		const { className } = props
		const baseClass = 'h-3 w-auto fill-current text-primary'
